...
public protocol BaseSectionControllerProtocol: AnyObject {
    var section: BaseSectionIdentifier { get }
    ...
    init(section: BaseSectionIdentifier)
}

/// Represent a Section in the ListView
open class BaseSectionController<T: DiffableModel, V: UIView>: BaseSectionControllerProtocol {

    public let section: BaseSectionIdentifier
