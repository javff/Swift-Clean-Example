...
public final class ListAdapter {
    ...
    var currentSections: [BaseSectionData] = []
    var loadedSections: [BaseSectionData] = []
...
extension ListAdapter: ListViewProtocol {
    ...
    public func loadSections(_ sections: [BaseSectionData]) {
    ...
    public func updateSection(_ section: BaseSectionData) {
    ...
    public func appendSection(_ section: BaseSectionData) {
    ...
    public func insertSection(_ section: BaseSectionData, at index: Int) {
        insertSectionInContainer(section, at: index)
    }

    func insertSectionInContainer(_ section: BaseSectionData, at index: Int? = nil) {
        guard let listView = listView,
