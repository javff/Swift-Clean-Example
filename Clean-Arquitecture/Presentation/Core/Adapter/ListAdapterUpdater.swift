...
public protocol ListAdapterUpdaterProtocol: AnyObject {
    func find(section: BaseSectionIdentifier) -> BaseSectionControllerProtocol?
...
public final class ListAdapterUpdater: ListAdapterUpdaterProtocol {
    ...
    final public func find(section: BaseSectionIdentifier) -> BaseSectionControllerProtocol? {
